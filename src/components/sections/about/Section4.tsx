...
export default function AboutSection4() {
  ...
  return (
    <section className='pt-10 pb-6 sm:pb-32 sm:pt-10 bg-primary-800'>
      <Container className='slider-container overflow-hidden'>
        <div className='m-6'>
          <h1 className='block font-medium text-white text-2xl md:text-3xl lg:text-4xl text-center'>
            ...
            <span className='text-primary-500'> {about.section4.overline}</span>
          </h1>
        </div>
      </Container>
      <Slider
      ...
      >
        {about.section4.carousel?.map((item) => (
          <div
            key={item.title}
